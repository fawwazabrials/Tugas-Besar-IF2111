...
int main() {
    ...
    MakeEmpty(&T);
    printf("Test isEmpty T (1 true 0 false, expected 1): %d\n",IsEmpty(T));
    printf("Test isFull T (1 true 0 false, expected 0): %d\n",IsFull(T));
    printf("Test nbElmt T (expected 0): %d\n",NbElmt(T));
    printf("Test MaxNbEl T (expected 100): %d\n",MaxNbEl(T));
    printf("Test GetFirstIdx T (expected 1): %d\n",GetFirstIdx(T));
    printf("Test GetLastIdx T (=nbElmt, expected 0): %d\n",GetLastIdx(T));
    printf("Test displayArray T. Expected \"Tabel kosong\"\n");
    DisplayArray(T);printf("\n");
    Word w;
    w.Length = 2;
    w.TabWord[0] = 'H';
    w.TabWord[1] = 'i';
    printf("Test GetElmtIdx T (input \"Hi\"; expected -999): %d\n",GetElmtIdx(T,w));
    SetEl (&T,1,w);
    printf("Insert word \"Hi\" to T with SetEl.\n");
    printf("Test isEmpty T (1 true 0 false, expected 0): %d\n",IsEmpty(T));
    printf("Test GetElmtIdx T (input \"Hi\"; expected 1): %d\n",GetElmtIdx(T,w));
    printf("Test nbElmt T (expected 1): %d\n",NbElmt(T));
    printf("Test GetLastIdx T (=nbElmt, expected 1): %d\n",GetLastIdx(T));
    printf("Test displayArray T. Expected one word \"Hi\"\n");
    DisplayArray(T);printf("\n");
    Word w2;
    w2 = GetElmt(T,1);
